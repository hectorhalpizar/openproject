shared_examples 'can upload an IFC file' do
  ...
  shared_examples 'should allow uploading an IFC file' do
  ...
  context 'set checkbox is_default before selecting file' do
    let(:set_tick_is_default_after_file) { false }

    it_behaves_like 'should allow uploading an IFC file'
  end

  context 'set checkbox is_default after selecting file' do
    it_behaves_like 'should allow uploading an IFC file'
  end
end
